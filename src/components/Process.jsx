            ...
            <Wrapper>
                ...
                <div>
                    ...
                    <ProcessCard
                        ...
                        desc={
                            <>
                                With the visual style confirmed, I develop all final assets, including graphics, layouts, animations, and templates, according to the project scope.
                                <br />
                                <br />
                                This phase includes refinement, consistency checks, and preparation for delivery across platforms.
                            </>
                        }
                    />
